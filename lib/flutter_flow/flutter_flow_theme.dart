...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6E1737);
  late Color secondary = const Color(0xFFC79B66);
  late Color tertiary = const Color(0xFF6E1737);
  late Color alternate = const Color(0xFF95A1AC);
  late Color primaryText = const Color(0xFF6E1737);
  late Color secondaryText = const Color(0xFF060000);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFEAEAEA);
  late Color accent1 = const Color(0xFFC79B66);
  late Color accent2 = const Color(0xFFFFFFFF);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFFEAEAEA);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6E1737);
  late Color secondary = const Color(0xFFC79B66);
  late Color tertiary = const Color(0xFFC79B66);
  late Color alternate = const Color(0xFF95A1AC);
  ...
  late Color accent1 = const Color(0xFFC79B66);
  late Color accent2 = const Color(0xFFC79B66);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xB2262D34);
  late Color success = const Color(0xFF6E1737);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);
}
