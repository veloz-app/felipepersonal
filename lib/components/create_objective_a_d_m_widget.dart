...
import 'create_objective_a_d_m_model.dart';
export 'create_objective_a_d_m_model.dart';

class CreateObjectiveADMWidget extends StatefulWidget {
  const CreateObjectiveADMWidget({super.key});

  @override
  State<CreateObjectiveADMWidget> createState() =>
      _CreateObjectiveADMWidgetState();
}

class _CreateObjectiveADMWidgetState extends State<CreateObjectiveADMWidget> {
  late CreateObjectiveADMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateObjectiveADMModel());

    _model.objetiveNameADMTextController ??= TextEditingController();
    _model.objetiveNameADMFocusNode ??= FocusNode();

    _model.tipeObjectiveADMTextController ??= TextEditingController();
    _model.tipeObjectiveADMFocusNode ??= FocusNode();

    _model.objectiveDetailsADMTextController ??= TextEditingController();
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                          .isDataUploading_uploadImageObjectiveADMCreate =
                                      true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadImageObjectiveADMCreate =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadImageObjectiveADMCreate =
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: !((/* NOT RECOMMENDED */ _model
                                            .tipeObjectiveADMTextController
                                            .text ==
                                        'true') &&
                                    (_model.objetiveNameADMTextController
                                                .text !=
                                ...
                                ? null
                                : () async {
                                    await ObjectivesRecord.collection
                                        .doc()
                                        .set(createObjectivesRecordData(
                                          nameObjective: _model
                                              .objetiveNameADMTextController
                                              .text,
                                          typeObjective: _model
                                              .tipeObjectiveADMTextController
                                              .text,
                                          description: _model
                                              .objectiveDetailsADMTextController
                                              .text,
                                          imageDisplay: _model
