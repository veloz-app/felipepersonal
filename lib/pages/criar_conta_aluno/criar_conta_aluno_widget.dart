...
import 'criar_conta_aluno_model.dart';
export 'criar_conta_aluno_model.dart';

class CriarContaAlunoWidget extends StatefulWidget {
  const CriarContaAlunoWidget({super.key});

  static String routeName = 'CriarContaAluno';
  static String routePath = '/criarContaAluno';

  @override
  State<CriarContaAlunoWidget> createState() => _CriarContaAlunoWidgetState();
}

class _CriarContaAlunoWidgetState extends State<CriarContaAlunoWidget> {
  late CriarContaAlunoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarContaAlunoModel());
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 25.0, 0.0, 17.0),
                    ...
                    onPressed: () async {
                      ...
                      await UserRecord.collection
                          ...
                          .update(createUserRecordData(
                            ...
                            displayName: _model.nomeTextController1.text,
                            sobrenome: _model.nomeTextController2.text,
                            photoUrl: '',
                            uid: '',
                            isAdm: false,
                            isAluno: false,
                            sexo: _model.dropDownValue,
                            dataDeNascimento: _model.textController5.text,
                            idade: int.tryParse(_model.textController4.text),
                            phoneNumber: '',
                          ));
